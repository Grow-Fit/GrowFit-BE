...
public class UserController {
    ...
    @PutMapping("/parent")
    public ResultResponse<String> updateParentInfo(@RequestBody ParentInfoRequestDto request,
    ...
    @PutMapping("/child")
    public ResultResponse<String> updateChildInfo(@RequestBody ChildInfoRequestDto request) {
